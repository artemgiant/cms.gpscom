<!-- Modal -->
<div class="modal fade" id="editOperator" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
     aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLongTitle">Редактировать оператора</h5>
                            ...
                            <div class="col">
                                <div class="row d-flex justify-content-around">
                                    <div class="form-group w-100">
                                        ...
                                        <div class="col-sm-12">
                                            <input type="text" id="operatorTitle" class="form-control"
