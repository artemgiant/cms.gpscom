...
<head>
    <base href="">
    <meta charset="utf-8"/>
    <title>GPS Compass Manager</title>
            ...
            <div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
                ...
                <div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1"
                    ...
                    <ul class="menu-nav">
                        ...
                        <li class="menu-item {{ request()->routeIs('clients') ? 'menu-item-active' : '' }}"
                            aria-haspopup="true">
                        ...
                        <li class="menu-item {{ request()->routeIs('equipments') ? 'menu-item-active' : '' }}"
                            aria-haspopup="true">
                            <a href="{{route('equipments')}}" class="menu-link">
                                <i class="fas fa-battery-full menu-icon"> </i>
                                <span class="menu-text">ОБОРУДОВАНИЕ</span>
                            </a>
                        </li>

                        <li class="menu-item {{ request()->routeIs('sim_cards') ? 'menu-item-active' : '' }}"
                            aria-haspopup="true">
                            <a href="{{route('sim_cards')}}" class="menu-link">
                                <i class="fas fa-id-card menu-icon"></i>
                                <span class="menu-text">SIM-КАРТЫ</span>
                            </a>
                        </li>

                        @if(auth()->user()->role_id == \App\Models\User::ADMIN)
                            <li class="menu-item {{ request()->routeIs('tariffs') ? 'menu-item-active' : '' }}"
                                aria-haspopup="true">
                                <a href="{{route('tariffs')}}" class="menu-link">
                                    <i class="far fa-money-bill-alt menu-icon"></i>
                                    <span class="menu-text">ТАРИФЫ</span>
                                </a>
                            </li>

                            <li class="menu-item {{ request()->routeIs('operators') ? 'menu-item-active' : '' }}"
                                aria-haspopup="true">
                                <a href="{{route('operators')}}" class="menu-link">
                                    <i class="fas fa-chalkboard-teacher menu-icon"></i>
                                    <span class="menu-text">ОПЕРАТОРЫ</span>
                                </a>
                            </li>
                        @endif

                        @if(auth()->user()->role_id == \App\Models\User::ADMIN || auth()->user()->role_id == \App\Models\User::MANAGER)
                            <li class="menu-item {{ request()->routeIs('reporting') ? 'menu-item-active' : '' }}"
                                aria-haspopup="true">
                                <a href="{{route('reporting')}}" class="menu-link">
                                    <i class="fas fa-chart-line menu-icon"></i>
                                    <span class="menu-text">ОТЧЕТНОСТЬ</span>
                                </a>
                            </li>
                        @endif

                        @if(auth()->user()->role_id == \App\Models\User::ADMIN)
                            <li class="menu-item {{ request()->routeIs('notifications') ? 'menu-item-active' : '' }}"
                                aria-haspopup="true">
                                <a href="{{route('notifications')}}" class="menu-link">
                                    <i class="fas fa-envelope-open-text menu-icon"></i>
                                    <span class="menu-text">УВЕДОМЛЕНИЯ
                                    @if(\App\Models\Notification::where('status', true)->count())
                                            <span
                                                class="label ml-2 label-info label-inline">{{\App\Models\Notification::where('status', true)->count()}}</span>
                                        @endif
                                </span>
                                </a>
                            </li>

                            <li class="menu-item {{ request()->routeIs('analytics') ? 'menu-item-active' : '' }}"
                                aria-haspopup="true">
                            ...
                            <li class="menu-item {{ request()->routeIs('setting') ? 'menu-item-active' : '' }}"
                                aria-haspopup="true">
                                <a href="{{route('setting')}}" class="menu-link">
                                    <i class="fas fa-cog menu-icon"></i>
                                    <span class="menu-text">НАСТРОЙКА</span>
                                </a>
                            </li>
                        @endif
...
<script src="{{ asset('super_admin/js/super_admin.js') }}"></script>
