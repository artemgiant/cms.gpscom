<!-- Modal -->
<div class="modal fade" id="createSim" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
     aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLongTitle">Добавить Sim</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <i aria-hidden="true" class="ki ki-close"></i>
                </button>
            </div>

            <form action="{{ route('sim_card.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                            ...
                            <div class="row d-flex justify-content-around">
                                <div class="form-group w-100">
                                    <label for="createSeller"
                                           class="col-sm-12 col-form-label font-weight-bold">Номер:</label>
                                    <div class="col-sm-12">
                                        <input type="text" class="form-control phone" name="phone" placeholder="Номер"
                                               required/>
                                    </div>
                                </div>
                            </div>
