<!-- Modal -->
<div class="modal fade" id="editTariff" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
     aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLongTitle">Редактирование тарифа</h5>
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="row d-flex justify-content-around">
                                <div class="form-group w-100">
                                    ...
                                    <div class="col-sm-12">
                                        <input type="text" class="form-control" id="tariffTitle"
                                               name="title" placeholder="Тариф" required>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col">
                            <div class="row d-flex justify-content-around">
                                <div class="form-group w-100">
                                    ...
                                    <div class="col-sm-12">
                                        <input type="number" class="form-control" id="tariffPrice" name="price" min="0"
                                               step="0.1"
                        ...
                        <div class="col">
                            <div class="row d-flex justify-content-around">
                                <div class="form-group w-100">
                                    <label for="createSeller"
                                           class="col-sm-12 col-form-label font-weight-bold">Оператор:</label>
                                    <div class="col-sm-12">
                                        <select id="tariffOperatorId" class="form-control" name="operator_id" data-size="7"
