...
<div class="modal fade" id="editUser" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            ...
            <form id="form_user_edit" action="{{ route('user.update') }}" method="POST"
                    ...
                    <div class="row">
                            ...
                            <div class="row d-flex justify-content-around">
                                <div class="form-group w-100">
                                    <label for="createSeller"
                                           class="col-sm-12 col-form-label font-weight-bold">Имя:</label>
                                    <div class="col-sm-12">
                        ...
                        <div class="col">
                            <div class="row d-flex justify-content-around">
                                <div class="form-group w-100">
                                    <label for="createSeller"
                                           class="col-sm-12 col-form-label font-weight-bold">Фамилия:</label>
                                    <div class="col-sm-12">
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="row d-flex justify-content-around">
                                <div class="form-group w-100">
                                    <label for="createSeller"
                                           class="col-sm-12 col-form-label font-weight-bold">Роль:</label>
                                    <div class="col-sm-12">
                                        <select class="form-control" name="role_id" id="userRole" data-size="7"
                        ...
                        <div class="col">
                            <div class="row d-flex justify-content-around">
                                <div class="form-group w-100">
                                    <label for="createSeller"
                                           class="col-sm-12 col-form-label font-weight-bold">Телефон:</label>
                                    <div class="col-sm-12">
                                        <input type="text" class="form-control userPhone" name="phone"
                                               placeholder="Телефон" id="kt_datetimepicker_1" required/>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            <div class="row d-flex justify-content-around">
                                <div class="form-group w-100">
                                    <label for="createSeller"
                                           class="col-sm-12 col-form-label font-weight-bold">Пароль:</label>
                                    <div class="col-sm-12">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-lg btn-primary mr-2 editUserBtn">Сохранить</button>
                </div>
