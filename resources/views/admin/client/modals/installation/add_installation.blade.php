<!-- Modal -->
<div class="modal fade" id="addInstallation" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
     aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <form id="form_add_installation" action="{{ route('client.installation.store') }}" method="POST"
                  enctype="multipart/form-data">
                @csrf

                <input type="hidden" name="equipment_id" id="installationEquipmentId">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="input-group date" id="kt_datetimepicker_30"
                                            ...
                                            <input type="text" class="form-control datetimepicker-input"
                                                   name="date_create"
                                                   placeholder="Дата договора" data-target="#kt_datetimepicker_30"/>
                        ...
                        <div class="col">
                            <div class="row d-flex justify-content-around">
                                <div class="form-group w-100">
                                    ...
                                    <div class="col-sm-12">
                                        <select class="form-control" name="type" data-size="7" data-live-search="true">
                        ...
                        <div class="col">
                            <div class="row d-flex justify-content-around">
                                <div class="form-group w-100">
                                    ...
                                    <div class="col-sm-12">
                                        <input type="number" min="0" step="0.01" class="form-control" name="price" placeholder="Стоимость"/>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-lg btn-primary mr-2 addInstallationBtn">Сохранить</button>
                </div>
