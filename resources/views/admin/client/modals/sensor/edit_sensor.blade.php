<!-- Modal -->
<div class="modal fade" id="editSensor" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
     aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLongTitle">Редактирование сенсора</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <i aria-hidden="true" class="ki ki-close"></i>
                </button>
            </div>

            <form id="form_update_sensor" action="{{ route('client.sensor.update') }}" method="POST" enctype="multipart/form-data">
                @csrf

                <input type="hidden" name="id" id="sensorId">
                        ...
                        <div class="col">
                            <div class="row d-flex justify-content-around">
                                <div class="form-group w-100">
                                    ...
                                    <div class="col-sm-12">
                                        <input type="text" class="form-control" name="name" id="sensorName" placeholder="Имя"/>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col">
                            <div class="row d-flex justify-content-around">
                                <div class="form-group w-100">
                                    ...
                                    <div class="col-sm-12">
                                        <input type="text" class="form-control" name="type" id="sensorType" placeholder="Тип"/>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col">
                            <div class="row d-flex justify-content-around">
                                <div class="form-group w-100">
                                    ...
                                    <div class="col-sm-12">
                                        <input type="text" class="form-control" name="sensor_id" id="sensorSensorId" placeholder="Id"/>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-lg btn-primary mr-2 updateSensorBtn">Сохранить</button>
                </div>
