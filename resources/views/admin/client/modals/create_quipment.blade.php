...
<div class="modal fade" id="createEquipments" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <form action="{{ route('client.equipment.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="modal-body">
                    ...
                    <div class="row d-flex justify-content-around">
                        <div class="form-group w-100">
                            <label for="createSeller"
                                   class="col-sm-12 col-form-label font-weight-bold">Обьєет:</label>
                            <div class="col-sm-12">
                                <input type="text" class="form-control" name="object" placeholder="Обьєет" required/>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row d-flex justify-content-around">
                        <div class="form-group w-100">
                            ...
                            <div class="col-sm-12">
                                <select class="form-control" name="device" data-size="7" data-live-search="true">
                        ...
                        <div class="form-group w-100">
                            ...
                            <div class="col-sm-12">
                                <input type="text" class="form-control phone" name="phone"
                                       placeholder="Номер устройства" id="kt_phone_input" required/>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="form-group w-100">
                            ...
                            <div class="col-sm-12">
                                <input type="text" class="form-control phone" name="phone2"
                                       placeholder="Номер устройства 2" id="kt_phone_input2"/>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="col-sm-12">
                                <div class="input-group date" id="kt_datetimepicker_10" data-target-input="nearest">
                                    <input type="text" class="form-control datetimepicker-input" name="date_start"
                                           placeholder="Дата подключения" data-target="#kt_datetimepicker_10"/>
                    ...
                    <div class="row d-flex justify-content-around">
                        <div class="form-group w-100">
                            ...
                            <div class="col-sm-12">
                                <select class="form-control" name="tariff_id" data-size="7" data-live-search="true">
