...
@section('title')
    <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">{{ $client->name }} - Реестр</h5>
                                            ...
                                            @foreach($equipments as $equipment)
                                                <tr class="equipment_item equipment_{{ $equipment->id }} @if($equipment->status == \App\Models\Equipment::DEACTIVE) deactive_equipment @endif">
                                                    ...
                                                    <td class="text-center pl-0 date_start">
                                                        {{ date('d.m.Y', strtotime($equipment->date_start)) }}
                                                    </td>
                                                    ...
                                                    <td class="text-center pl-0">
                                                        {{ isset($fixedEquipmentPrice) ? $fixedEquipmentPrice : $equipment->getPrice()  }}
                                                    </td>
                                                </tr>
                                            @endforeach
                                            <tr>
                                                <td class="text-right pl-0" colspan="9">
                                                    {{ 'Всего: ' . $client->getPerMountPrice() }}
                                                </td>
                                            </tr>
                                            </tbody>
                                        </table>
