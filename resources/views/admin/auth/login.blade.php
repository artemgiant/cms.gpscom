    ...
    <div class="login login-1 login-signin-on d-flex flex-column flex-lg-row flex-column-fluid bg-white" id="kt_login">
        ...
        <div class="login-aside d-flex flex-column flex-row-auto" style="background-color: #F2C98A;">
            ...
            <div class="d-flex flex-column-auto flex-column pt-lg-40 pt-15">
                ...
                <!--end::Aside header-->
                <!--begin::Aside title-->
                <h3 class="font-weight-bolder text-center font-size-h4 font-size-h1-lg" style="color: #986923;">GPS Compass Manager</h3>
                <!--end::Aside title-->
            </div>
            <!--end::Aside Top-->
            <!--begin::Aside Bottom-->
            <div class="aside-img d-flex flex-row-fluid bgi-no-repeat bgi-position-y-bottom bgi-position-x-center" style="background-image: url({{ asset('super_admin/media/svg/illustrations/login-visual-1.svg') }})"></div>
            <!--end::Aside Bottom-->
        </div>
        <!--begin::Aside-->
        <!--begin::Content-->
        <div class="login-content flex-row-fluid d-flex flex-column justify-content-center position-relative overflow-hidden p-7 mx-auto">
            ...
            <div class="d-flex flex-column-fluid flex-center">
                ...
                <div class="login-form login-signin">
                    <!--begin::Form-->
                    <form class="form" novalidate="novalidate" id="kt_login_signin_form" action="{{ route('login', app()->getLocale()) }}" method="POST">
                        <!--begin::Title-->
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control form-control-solid h-auto py-6 px-6 rounded-lg" name="email" type="email" autocomplete="off" value="admin@gmail.com" />
                        </div>
                        <!--end::Form group-->
                        <!--begin::Form group-->
                        <div class="form-group">
                            ...
                            <input class="form-control form-control-solid h-auto py-6 px-6 rounded-lg" name="password" type="password" autocomplete="off" />
                        </div>
                        <!--end::Form group-->
                        <!--begin::Action-->
                        <div class="pb-lg-0 pb-5">
                            <button type="submit" id="kt_login_signin_submit" class="btn btn-primary font-weight-bolder font-size-h6 px-8 py-4 my-3 mr-3">Войти</button>
                        </div>
                        <!--end::Action-->
                    </form>
                    <!--end::Form-->
                ...
                <div class="login-form login-forgot">
                    ...
                    <!--begin::Title-->
                        <div class="pb-13 pt-lg-0 pt-5">
                            ...
                            <p class="text-muted font-weight-bold font-size-h4">Введите адрес электронной почты, чтобы
                                сбросить пароль</p>
                        </div>
                        <!--end::Title-->
                        <!--begin::Form group-->
                        ...
                        <div class="input @error('g-recaptcha-response') error @enderror mb-3" id="recaptcha">
                            <div class="g-recaptcha" data-sitekey="6LftRuQiAAAAAFMtmGkzk1gzEaka4f3XEI8DNQON"></div>
