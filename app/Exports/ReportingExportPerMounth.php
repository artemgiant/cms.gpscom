...
class ReportingExportPerMounth implements FromCollection, WithColumnWidths, WithStyles
{
    public function collection()
    {
        ...
        foreach ($rows as $row) {
            ...
            if ($price) {
                ...
                $rowProperty['count_start'] = $row->getReportingEquipment();
        ...
        $prepend = $cols;
        $prepend['count_start'] = 'Начальное кол-во';
