...
var KTMaskDemo = function () {
    ...
    var demos = function () {
        ...
        $('#kt_phone_input').mask('+00000000000', {
            placeholder: "+",
        });

        $('#kt_phone_input2').mask('+00000000000', {
            placeholder: "+",
        });

        $('#kt_phone_input3').mask('00000000000');

        $('#kt_phone_with_ddd_input1').mask('(000)-009-99-99', {
            placeholder: "(000)-009-99-99"
        });

        $('#kt_phone_with_ddd_input2').mask('(000)-009-99-99', {
            placeholder: "(000)-009-99-99"
        });
